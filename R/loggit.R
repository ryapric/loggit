...
#'
#' This function slots itself into a comfortable spot in the function
#' definitions for base handler functions (\code{\link[base]{message}},
#' \code{\link[base]{warning}}, and \code{\link[base]{stop}}), and logs their
